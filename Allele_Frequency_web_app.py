...
def result():
   if request.method == 'POST':
      ...
      return render_template("HW_result.html", allele = allele_result_dict, HW = HW, Chi = Chi_Square_value, p_value = chi_test[1], CI = CI_dict, obs = Observed_result_dict, exp = Expected_result_dict)
